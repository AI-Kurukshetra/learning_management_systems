...
export default async function AdminDashboardPage() {
  ...
  return (
    <AppShell
      ...
      description="Navigate the parent, teacher, student, course, and enrollment modules from the protected admin panel."
      viewer={viewer}
    >
      ...
      <section className="mt-8 grid gap-8 xl:grid-cols-3">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-white">Recent parents</h2>
            <Link href="/admin/parents" className="text-sm text-cyan-300">
              Open module
            </Link>
          </div>
          <div className="mt-5 space-y-3">
            ...
            {users.filter((user) => user.role === "parent").length === 0 ? (
