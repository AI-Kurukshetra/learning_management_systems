    ...
    >
      <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <Link
            href={`/teacher/courses/${detail.course.id}`}
      ...
      <div className="mt-8 grid gap-8 xl:grid-cols-[0.8fr,1.2fr]">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
          <p className="text-xs uppercase tracking-[0.24em] text-cyan-300">Progress</p>
          <h3 className="mt-2 text-xl font-semibold text-white">Submission summary</h3>
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl bg-slate-900/70 p-4">
              <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Received</p>
        ...
        <GradeTable
          ...
          redirectPath={`/teacher/assignments/${detail.assignment.id}`}
        />
      </div>
    </AppShell>
  );
